...
// والصفحة الروسية مثلها (دفعة ru-dining 2026-09-18): الاسم نفسه على بطاقة المخبز
// لاتينيّ حتى ب5، واقترانه الموثّق بالروسية «Финиковый хлеб» في سطر المخابز.
const SYNONYM_PAIRS = [
  { alias: 'الخبز الأحمر', canonicals: ['خبز التمر'] },
  // والألمانية كذلك (ج6 de-din 2026-09-19): «…for Hasawi Red Bread» اسم المخبز اللاتيني على بطاقته،
  // واقترانه الموثّق «Dattelbrot» في سطر المخابز وسؤال الخبز الأحمر.
  { alias: 'red bread', canonicals: ['date bread', '椰枣面包', 'Финиковый хлеб', 'Dattelbrot'] },
  ...
  // @de-food:c5b — الألمانية تصرّف الصفة («rotes Brot»، «rotem Brot») فالمرساة على العبارة
  // بجذعيها، بحدٍّ أيسر صريح لا \b (‏«Karotten Brot» تحوي «rotten Brot»، وä/ö/ü/ß ليست حروف كلمة
  // في JS). والقرين اسم الطبق مركّباً ثابتاً — لا يتصرّف فتكفيه سلسلة حرفية.
  { alias: '(?<![A-Za-zÄÖÜäöüß])rot(?:e|es|er|en|em)?\\s+Brot', canonicals: ['Dattelbrot'] },
];
