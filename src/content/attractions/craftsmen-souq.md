...
category: market
kicker: "سوق حرفي"
summary: "سوق في قلب الهفوف التاريخية يجمع الحرفيين ومتاجرهم وأكاديمية لتعليم الحرف اليدوية، بإشراف أمانة الأحساء."
summary_en: "A souq in the heart of historic Hofuf gathering artisans, their shops and a handicrafts academy, overseen by Al-Ahsa Municipality."
body_en: "In the historic centre of Hofuf stands the Craftsmen Souq, opened in March 2020 to support handicrafts and folk arts. Spread over more than 12,000 square metres, it houses 112 shops for artisans, an open courtyard, a traditional coffee house, a tannour bakery and an events plaza, along with an academy where experienced craftspeople teach their trades to new generations — a mission bound up with Al-Ahsa's accession to the UNESCO Creative Cities Network. The souq was created as part of the projects to develop historic downtown Hofuf, and it is run by Al-Ahsa Municipality."
...
# أسئلة الروسية: معتمدة من خط ru-translation-pipeline بدرجة 90/100 (2026-09-08، الدفعة ru-attr-10 — السجل في ru-translation/memory/scores.csv).
faq:
...
للحرف اليدوية والفنون الشعبية. يمتد السوق على مساحة تزيد على 12 ألف متر
مربع، ويضم 112 متجراً للحرفيين، إلى جانب فناء مفتوح وقهوة شعبية ومخبز
تنور وساحة للفعاليات.

وفي السوق **أكاديمية لتعليم الحرف اليدوية** يديرها حرفيون ذوو خبرة، ينقلون
صنعتهم للأجيال الجديدة — وهو ما يرتبط بانضمام الأحساء إلى شبكة المدن
الإبداعية في اليونسكو. جاء إنشاء السوق ضمن مشاريع تطوير وسط الهفوف
التاريخي، وتشرف عليه أمانة الأحساء.
