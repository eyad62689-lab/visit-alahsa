...
// النسخة الروسية — خط ru-translation-pipeline حصراً (دفعة ru-food 2026-09-09).
// الاقتران «красный хлеб»/финиковый хлеб على البطاقة نفسها (‏C5b، وزوجه الروسي
// أُضيف إلى SYNONYM_PAIRS في هذه الدفعة — كان الفحص يتخطّى الصفحة صامتاً بدونه).
export const DISH_GROUPS_RU: DishGroup[] = [
  {
    title: '',
    dishes: [
      { img: '/img/food/hasawi-rice-v2', alt: 'Рис Аль-Ахсы помешивают в глиняном котле на дровяном огне', k: 'Основное блюдо', name: 'Рис Аль-Ахсы',
        pre: 'Одно из самых известных блюд Аль-Ахсы: местный рис Аль-Ахсы, который готовят с мясом или курицей, томатным соусом и специями (сушёный лайм, корица, кардамон), пока он не приобретёт красновато-коричневый цвет и насыщенный вкус. Его подают на торжествах и когда принимают гостей.' },
      { img: '/img/food/mandi-v2', alt: 'Блюдо манди рядом с раскалённой горловиной тандыра', k: 'Основное блюдо', name: 'Манди',
        pre: 'В Аль-Ахсе манди не столько готовят, сколько доверяют земле — так доверяют тайны. Мясо часами вбирает дыхание глиняного тандыра, а рис несёт запах пальм и дыма. В этом блюде — история оазиса, который знал щедрость раньше, чем нашёл для неё слова.' },
      { img: '/img/food/harees-v3', alt: 'Харису помешивают в котле на дровяном огне', k: 'Основное блюдо', name: 'Хариса',
        pre: 'Пшеница и мясо часами соединяются, пока не станут единой душой, — так рождается хариса. Это главное угощение на пирах и свадьбах Аль-Ахсы, и с давних пор его подают за столом в Рамадан.' },
      { img: '/img/food/mufallaq-v2', alt: 'Муфаллак из дроблёной пшеницы с финиками готовят в котле на дровяном огне в оазисе', k: 'Основное блюдо', name: 'Муфаллак',
        pre: 'Традиционное блюдо Аль-Ахсы из дроблёной пшеницы (джариш): её готовят со специями и сушёным лаймом, а потом украшают финиками и варёными яйцами. Это сытное кушанье, в котором сошлись вкусы оазиса.' },
      { img: '/img/food/balaleet-v2', alt: 'Вермишель для балалита обжаривают на дровяном огне рядом со сковородой для омлета', k: 'Десерт', name: 'Балалит с финиковой патокой',
        pre: 'Золотистая вермишель с ароматом шафрана и кардамона. Подслащивают её финиковой патокой — так принято в Аль-Ахсе. В краю, который и есть столица пальм, сладость даёт сам финик.' },
      { img: '/img/food/date-asida-v2', alt: 'Тарелка финиковой асиды: в середине лунка финиковой патоки, рядом финики и кофейник', k: 'Десерт', name: 'Финиковая асида',
        pre: 'Финики самой Аль-Ахсы тают в пшеничной муке на тихом огне. Асиду терпеливо помешивают, пока она не загустеет и не заблестит от шафрана, а потом венчают топлёным маслом и щепоткой чёрного перца — он и придаёт асиде тепла. Это зимнее лакомство Аль-Ахсы: вокруг него семья собирается в холодные ночи.' },
      { img: '/img/food/sago', alt: 'Саго, украшенное грецкими орехами и фисташками', k: 'Десерт', name: 'Саго',
        pre: 'Зёрнышки тают на огне и превращаются в прозрачную драгоценность, которая мерцает шафраном и кардамоном. Это лакомство Аль-Ахсы царит на столах Рамадана — нежное по консистенции, с давней историей. Способ его приготовления жители оазиса передают из поколения в поколение.' },
      { img: '/img/food/date-bread-v2', alt: 'Финиковый хлеб на сковороде перед пылающей глиняной печью', k: 'Хлеб', name: 'Финиковый хлеб',
        pre: 'Местный хлеб: финиковую пасту вмешивают в тесто или кладут внутрь, а сверху посыпают чёрным тмином (чернушкой) — так соединяются добрый хлеб и сладость фиников. Его подают с арабским кофе. Ещё его называют «красным хлебом» (хубз ахмар).' },
    ],
  },
];
