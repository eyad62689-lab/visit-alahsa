...
export const RESTAURANTS_AR: Place[] = [
  { ...P.darBasma, name: 'دار بسمة', area: 'بجوار حديقة قصر إبراهيم — الهفوف', alt: 'واجهة دار بسمة الزجاجية وجلساتها الخارجية بين النخيل مساءً',
    blurb: 'جلسات خارجية بين النخيل وواجهة زجاجية على طرف حديقة قصر إبراهيم.' },
  { ...P.alkoot, name: 'مطعم فندق الكوت', area: 'حي الكوت — مقابل قصر إبراهيم', alt: 'الفناء الداخلي لفندق الكوت التراثي بأروقته وسقفه الزجاجي',
  ...
  { ...P.sinyar, name: 'مطعم سنيار', area: 'طريق الخليج — العويمرية', alt: 'واجهة مطعم سنيار الترابية وشعاره بالخط العربي عند المساء',
...
export const CAFES_AR: Place[] = [
  { ...P.baithana, name: 'مقهى بيذانة', area: 'حي الرفعة الشمالية — الهفوف', alt: 'مدخل مقهى بيذانة بجدرانه الطينية وبابه الخشبي في حارة تراثية',
    blurb: 'بيت طيني بباب خشبي في حارة من حارات الهفوف القديمة.' },
  { ...P.sevenSt, name: 'شارع 7', area: 'حي الرفعة الشمالية — الهفوف', alt: 'ركن جلوس بكراسٍ جلدية ونافذة زجاج ملون داخل مقهى شارع 7',
  ...
  { ...P.soulaf, name: 'مقهى سلاف', area: 'طريق الملك عبدالله — الهفوف', alt: 'داخلية مقهى سلاف العصرية بشجرة الزيتون وسقفها الخشبي',
    blurb: 'داخلية عصرية هادئة تتوسطها شجرة زيتون تحت فتحة سماوية.' },
  { ...P.bakingUp, name: 'بيكنج آب', area: 'طريق عين نجم — المبرز', alt: 'واجهة بيكنج آب وجلساتها الخارجية بمظلاتها',
    blurb: 'مخبوزات ومقرمشات — كما يعرّف نفسه في خرائط قوقل — بواجهة مبهجة وجلسات خارجية.' },
  { ...P.dot, name: 'مقهى ومخبز دوت', area: 'طريق عين نجم — المبرز', alt: 'ركن الطلب وواجهة عرض المخبوزات في مقهى ومخبز دوت',
    blurb: 'مخبز ومقهى معاً: واجهة عرض للمخبوزات وركن طلب بلمسة زرقاء.' },
  { ...P.raslan, name: 'كرك رسلان', area: 'طريق الخليج', alt: 'أكواب الكرك على صينية خشبية مع أطباق فطور في كرك رسلان',
...
export const CAFES_EN: Place[] = [
  ...
  { ...P.raslan, name: 'Karak Raslan', area: 'Al-Khaleej Road', alt: 'Cups of karak on a wooden tray with breakfast dishes at Karak Raslan',
