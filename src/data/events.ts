    ...
    sections: [
      {
        ...
        ps: [
          ...
          'وترتبط به عادة أحسائية صيفية أصيلة: تجتمع الأسر لعصره وتخزينه («الجميد»: عصير اللومي المشمّس المعتّق) لاستعماله على مدار العام — طازجاً وعصيراً ومجففاً في المطبخ الأحسائي والخليجي.',
        ],
      },
      {
...
// المقاطع slug تشارك الإنجليزية كالصينية. بُنيت بخمس دفعات (ru-ev-2…5) واكتملت الفعاليات
// العشر، فشُدِّدت إلى EventTexts: فعالية جديدة بلا نصّ روسي تُفشل البناء لا تتراجع صامتةً.
const TEXT_RU: EventTexts = {
  // دفعة ru-ev-2 2026-09-17 — خط ru-translation-pipeline، الحاكم 94/100 · APPROVE (دورتان)
  bisht: {
    slug: 'hasawi-bisht-festival',
    name: 'Фестиваль бишта Аль-Ахсы', place: 'Историческая крепость Каср-Ибрахим, Эль-Хуфуф',
    season: 'Зима', time: 'Примерно в декабре', span: 'Несколько дней',
    org: 'Комиссия по наследию (Министерство культуры)',
    acts: ['Выставка бишта', 'Обучающие мастер-классы по ткачеству', 'Интерактивный рынок биштов', 'Фольклорные представления'],
  },
  'qaisariyah-nights': {
    slug: 'qaisariyah-nights',
    name: 'Ночи Эль-Кайсария', place: 'Исторический рынок Эль-Кайсария, Эль-Хуфуф',
    season: 'Поздняя зима', time: 'Февраль–март', span: 'Несколько недель',
    org: 'Муниципалитет Аль-Ахсы, Управление по развитию Аль-Ахсы, Комиссия по наследию',
    acts: ['Демонстрации народных искусств', 'Общественные посиделки', 'Традиционные игры', 'Ремесленные мастер-классы'],
  },
  'kafu-nights': {
    slug: 'kafu-nights',
    name: 'Ночи Кафу', place: 'Экологический парк короля Абдаллы, Эль-Хуфуф',
    season: 'Священный месяц Рамадан', time: 'В Рамадан', span: 'Продлённые ночи Рамадана',
    org: 'Университет короля Фейсала',
    acts: ['Театральные представления', 'Детская зона', 'Интерактивная кухня Кафу', 'Ужин «Габка»'],
  },
  'dates-festival': {
    slug: 'processed-dates-festival',
    name: 'Фестиваль переработки фиников', place: 'Форт муниципалитета Аль-Ахсы, Эль-Хуфуф',
    season: 'Зима', time: 'Январь–февраль', span: 'Несколько недель',
    org: 'Муниципалитет Аль-Ахсы, Управление по развитию Аль-Ахсы',
    acts: ['Павильон дегустации и покупок', 'Павильоны продукции из переработанных фиников', 'Культурные мастер-классы', 'Конкурсы'],
  },
  // دفعة ru-ev-3 2026-09-17 — خط ru-translation-pipeline، الحاكم 93/100 · APPROVE من الدورة الأولى
  'palm-village': {
    slug: 'palm-village',
    name: 'Пальмовая деревня', place: 'Оазис Аль-Ахса',
    season: 'Зима и весна', time: 'Январь–март', span: 'Продлённый сезон',
    org: 'Национальный центр пальм и фиников',
    acts: ['Финиковые лавки', 'Местные рестораны и кафе', 'Павильоны ремесленников (изделия из пальмовых листьев)', 'Продажа сельской продукции'],
  },
  'uqair-winter': {
    slug: 'al-uqair-winter',
    name: 'Зима в Эль-Укайре', place: 'Пляжный парк Эль-Укайр',
    season: 'Зима', time: 'Декабрь–февраль', span: 'Несколько недель',
    org: 'Управление по развитию Аль-Ахсы, муниципалитет Аль-Ахсы',
    acts: ['Семейные морские и спортивные мероприятия', 'Мастер-классы по декоративно-прикладному искусству', 'Весёлые игры'],
  },
  'wafrah-winter': {
    slug: 'al-wafrah-winter',
    name: 'Зима в Эль-Вафре', place: 'Район Эль-Вафра, к югу от Эль-Хуфуфа',
    season: 'Зима', time: 'Примерно с ноября', span: 'Продлённый зимний сезон',
    org: 'Владельцы и инвесторы под надзором муниципалитета Аль-Ахсы',
    acts: ['Более 150 фуд-траков', 'Народные блюда Аль-Ахсы', 'Зимние посиделки на открытом воздухе'],
  },
  'horse-racing': {
    slug: 'horse-racing-season',
    name: 'Сезон скачек', place: 'Конноспортивная арена Аль-Ахсы, Эт-Тараф',
    season: 'Зима', time: 'Ноябрь–февраль', span: 'Продлённый сезон',
    org: 'Конноспортивная арена Аль-Ахсы',
    acts: ['Скачки', 'Конноспортивные мероприятия'],
  },
  // دفعة ru-ev-4 2026-09-17 — خط ru-translation-pipeline، الحاكم 92/100 · APPROVE من الدورة الأولى
  'creative-ahsa': {
    slug: 'creative-alahsa-festival',
    name: 'Фестиваль творческой Аль-Ахсы', place: 'Исторический квартал Эль-Фридж, форт муниципалитета Аль-Ахсы',
    season: 'Весна', time: 'Март–апрель', span: 'Около недели',
    org: 'Муниципалитет Аль-Ахсы',
    acts: ['Гончарное дело', 'Изделия из пальмовых листьев', 'Традиционное столярное дело', 'Изобразительное искусство', 'Народные представления'],
  },
  lomi: {
    slug: 'hasawi-lomi-exhibition',
    name: 'Выставка лайма Аль-Ахсы', place: 'Выставочный центр Аль-Ахсы, улица Эс-Салям (дорога на Айн-Наджм), Эль-Хуфуф',
    season: 'Лето', time: '19 августа–13 сентября 2026 года', span: 'Около двадцати шести дней',
    org: 'Торгово-промышленная палата Аль-Ахсы',
    acts: ['Выставки продукции из лайма', 'Готовка вживую', 'Сельскохозяйственные мастер-классы', 'Детский уголок', 'Семейные посиделки'],
    intro: 'Выставка лайма Аль-Ахсы (также известная как «Выставка лимона Аль-Ахсы») — главное сезонное сельскохозяйственное событие оазиса: его организует Торгово-промышленная палата Аль-Ахсы в честь самого известного плода оазиса после фиников. На выставке в интерактивном формате можно узнать о свойствах, пользе и способах выращивания лайма Аль-Ахсы, пообщаться напрямую с фермерами, сделать покупки в лавках семейных производителей и принять участие в сопутствующей программе.',
    sections: [
      {
    ...
    faq: [
      { q: 'Где проходит выставка?', a: 'В Выставочном центре Аль-Ахсы на улице Эс-Салям (дорога на Айн-Наджм), в Эль-Хуфуфе — карта на этой странице.' },
      { q: 'Чем лайм Аль-Ахсы отличается от обычного лимона?', a: 'Он меньше по размеру, тоньше кожурой, сочнее и ароматнее; используется свежим, в виде сока и сушёным в кухне Аль-Ахсы.' },
      { q: 'Есть ли мероприятия для детей?', a: 'Да — на выставке есть детский уголок, а также готовка вживую, сельскохозяйственные мастер-классы и семейные посиделки.' },
    ],
    related: [
    ...
    after: {
      ...
      span: 'Несколько недель',
      seoTitle: 'Выставка лайма Аль-Ахсы: сезон, место и ключевые моменты',
      seoDesc: 'Выставка лайма Аль-Ахсы в Эль-Хуфуфе: ежегодно, примерно в августе–сентябре, с программой. Дата нового выпуска — в анонсах Торгово-промышленной палаты Аль-Ахсы.',
    },
  },
};
