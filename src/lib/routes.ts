...
type AttractionSlugs = { slug_ar: string; slug_en: string; title_zh?: string; title_de?: string };

/** رابط صفحة المعلم بلغة الطلب — بشرطة ختامية دائماً (تطابق canonical).
 *  الصينية والألمانية تشاركان الإنجليزية الـslug اللاتيني تحت /zh/ و/de/. */
 ...
 *  ترجمة ألمانية معتمدة (title_de) — فلا يظهر hreflang أو خيار في المبدّل
 *  لصفحة غير موجودة. */
export const attractionAlt = (d: AttractionSlugs): { ar: string; en: string; zh?: string; de?: string } => ({
...
/** روابط المنشأة بلغتيها — مصدر hreflang ومبدّل اللغة. لا نسخة صينية ولا ألمانية بعد،
 *  فلا يُدرجان هنا لئلا يقود المبدّل إلى 404. */
...
/** روابط مكان الإقامة بلغتيه — مصدر hreflang ومبدّل اللغة. لا نسخة صينية ولا ألمانية بعد،
 *  فلا يُدرجان هنا لئلا يقود المبدّل إلى 404. */
