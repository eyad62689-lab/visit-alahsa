...
export const UNLISTED: ReadonlyArray<{ path: string; noindex: boolean; why: string }> = [
  // فهرس المطاعم الروسي (المرحلة ب4) — كتلته تُترجَم في دفعتين، لكن بطاقاته التسع
  // والعشرين (نبذة وموقع ونصّ بديل) تبقى إنجليزية حتى تمرّ ب5، ومتونها حتى ب6.
  // فالإخراج من هنا لا يتبع ب4 وحدها بل ما يطبعه C22 بعد ب5.
  { path: '/ru/restaurants-cafes/', noindex: true, why: 'دفعتا ب4 قيد التنفيذ، و29 بطاقة تتراجع للإنجليزية حتى ب5' },
