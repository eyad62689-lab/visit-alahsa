...
export const UNLISTED: ReadonlyArray<{ path: string; noindex: boolean; why: string }> = [
  ...
  // title_de، والنسبةُ المقيسة بمنطق C22 نفسِه **9%** (15 كتلةً مطابقةً من
  // 160) — أي **تحت عتبة 20% سلفاً**، وكانت 52 من 58 و23% حين أُدرجت.
  // (‏أُعيد القياسُ على dist المبنيّ من 478bee1 فكان 15 لا 17؛ والفرقُ كتلتان
  // لا يغيّر حكماً، والكتلُ الباقيةُ كلُّها نبذاتُ البطاقات غير المترجَمة.)
