...
export const UNLISTED: ReadonlyArray<{ path: string; noindex: boolean; why: string }> = [
  // قياسٌ 2026-09-12 بعد دفعة المنتزهات (batch-de-5): 17 من 58 معلماً بلا
  // title_de، والنسبةُ المقيسة بمنطق C22 نفسِه **11%** (17 كتلةً مطابقةً من
  // 160) — أي **تحت عتبة 20% سلفاً**، وكانت 52 من 58 و23% حين أُدرجت.
  // فالبقاءُ هنا قرارُ خطةٍ لا إلزامَ حارس: جدولُ إكمال الترجمة يُخرجها بعد
  // المراحل 1–4 (الألمانية 56 من 58)، لا عند نزولها تحت العتبة. وإخراجُها
  // يُدخلها hreflang وsitemap ومبدّل اللغة، وهو قرارُ نشرٍ يملكه المالك.
