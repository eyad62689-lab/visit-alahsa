...
export const UNLISTED: ReadonlyArray<{ path: string; noindex: boolean; why: string }> = [
  // مقالان صينيان من ثمانية: البطاقات الإنجليزية الست تجعل الفهرس 83% إنجليزياً (قياس 2026-09-10
  // بعد نشر مقالَي 24 و48 ساعة) — يخرج من القائمة حين تُترجم بقية المقالات عبر الخط الصيني
  { path: '/zh/blog/', noindex: true, why: 'فهرس المدونة الصيني 83% إنجليزي بمقالين صينيين من ثمانية (الخطوة 10)' },
